...
Your program is completely incognizant that anything different is
...
The function {\tt ferror} takes a stream as its argument and returns
...
\begin{flushleft}
\verb% % \\*
\verb%   if (ferror(the_file)) {% \\*
\verb!     printf("Read error on file %s.\n", FILENAME);! \\*
\verb%     return 1; % \\*
\verb%   } else {% \\*
\verb%     return 0;% \\*
\verb%   }% \\*
...
addresses have type \p2\Char.  It takes the addresses and assembles them
...
the first element has type \p2\P2\Char.  Theoperating system arranges
